			...
			$(document).ready(function() {
				...
				$(".text1_li1").hover(function() {
						...
						$("#Robotics1, #Robotics2, #Robotics3").html("Robotics");
				});
				...
				$(".text2_li1").hover(function() {
						...
						$("#Build-It1,#Build-It2,#Build-It3").html("<h1>Spageridge</h1>Design and construct a model of a single span truss bridge with the help of spaghetti noodles satisfying the constraints stated below.<br><br><br>");
				},function(){
						$("#Build-It1,#Build-It2,#Build-It3").html("Build-It");
				});
				...
				$(".text3_li1").hover(function() {
						...
						$("#Coding1,#Coding2,#Coding3").html("Let's Code");
				});
				...
				$(".text4_li1").hover(function() {
						...
						$("#Management1,#Management2,#Management3").html("Management");
				});
				...
				$(".text5_li1").hover(function() {
						...
						$("#Treasure-Hunt1,#Treasure-Hunt2,#Treasure-Hunt3").html("Treasure-Hunt");
				});
				...
				$(".text8_li1").hover(function() {
						...
						$("#Quiz-Wiz1,#Quiz-Wiz2,#Quiz-Wiz3").html("Quiz-Wiz");
				});
				...
				$(".text9_li1").hover(function() {
						...
						$("#Social1,#Social2,#Social3").html("Social");
				});
